...
class HomePageBannerBlockController extends BlockController {
/*    ^^^^^^^^^^^^^^^
      CHANGE THIS PORTION
...
*/
	...
	protected $btTable = 'btHomePageBanner'; //Must be the same as table name in db.xml.
	                                          //Should correspond to block's directory/class name.
	
	public function getBlockTypeName() {
		return t('Home Page Banner'); //Appears in "Add Block" list when adding blocks to a page
	}
	
	public function getBlockTypeDescription() {
		return t('IDSystems Home Page image slider'); //Only appears in dashboard "Add Functionality" page
	}
