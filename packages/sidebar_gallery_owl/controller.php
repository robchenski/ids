...
class SidebarGalleryOwlPackage extends Package {
/*    ^^^^^^^^^^^^^^^
      CHANGE THIS PORTION
...
*/
	...
	protected $pkgHandle = 'sidebar_gallery_owl';
	protected $appVersionRequired = '5.4.1';
	protected $pkgVersion = '1.0';
	
	public function getPackageName() {
		return t('Sidebar Product Gallery');
	}
	
	public function getPackageDescription() {
		return t('Sidebar Gallery block, image slider etc. Choose your images from a file set...');
	}
