...
<style type="text/css">
	...
	.prev {
		...
		border-color: transparent #ff6410 transparent transparent;
	}
	.next {
		width: 0;
		height: 0;
		...
		border-color: transparent transparent transparent #ff6410;
	}
</style>
...
<div class="ccm-block-field-group">
	<p class="label"><strong>Use dots instead of nav buttons?</strong></p>
	<?php 
	$options = array(
		'0' => '-- Choose --',
		'1' => 'Yes',
	...
	echo $form->select('nav_show_value', $options, $nav_show_value);
	?>
</div>
