...
class SidebarGalleryOwlBlockController extends BlockController {
/*    ^^^^^^^^^^^^^^^
      CHANGE THIS PORTION
...
*/
	...
	protected $btTable = 'btSidebarGalleryOwl'; //Must be the same as table name in db.xml.
	                                          //Should correspond to block's directory/class name.
	
	public function getBlockTypeName() {
		return t('Sidebar Product Gallery'); //Appears in "Add Block" list when adding blocks to a page
	}
	
	public function getBlockTypeDescription() {
		return t('Sidebar Gallery block, image slider etc. Choose your images from a file set...'); //Only appears in dashboard "Add Functionality" page
	}
