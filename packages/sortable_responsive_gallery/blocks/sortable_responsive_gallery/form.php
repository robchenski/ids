...
<style>
	...
	#thumbnailsContainer { width: 785px; height: 300px; margin-top: 5px; border: 1px solid black; background:#f8f8f8; }
	...
	#galleryOptions{text-align: center}
...
<table id="galleryOptions" border="0">
	...
	<tr>
	<td colspan="6"><?php   echo t('<br><strong>Remember to set the thumbnail sizes to match the full size image</strong>');?></td>
	</tr>		
</table>
