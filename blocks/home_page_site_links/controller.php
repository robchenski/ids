...
class HomePageSiteLinksBlockController extends BlockController {
	
	protected $btName = 'Home Page Site Links';
	protected $btDescription = '3 item internal links block with image';
	protected $btTable = 'btDCHomePageSiteLinks';
