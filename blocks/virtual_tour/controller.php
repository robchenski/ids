...
class VirtualTourBlockController extends BlockController {
	
	protected $btName = 'Virtual Tour';
	protected $btDescription = 'IDSystems Google virtual tour';
	protected $btTable = 'btDCVirtualTour';
