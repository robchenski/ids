...
<div class="ccm-block-field-group">
	...
	<table border="0" cellspacing="3" cellpadding="0" style="width: 95%; margin-top: 5px;">
		<tr>
			<td align="right" nowrap="nowrap"><label for="field_5_image_altText">Alt Text:</label>&nbsp;</td>
			<td align="left" style="width: 100%;"><?php  echo $form->text('field_5_image_altText', $field_5_image_altText, array('style' => 'width: 100%;')); ?></td>
		</tr>
	</table>
</div>
